...
COMPOSE_EPHEMERAL="sources/compose-files/docker-compose-no-volumes.yml"
COMPOSE_MOUNTED="sources/compose-files/docker-compose-mounted.yml"

echo "***************************"
echo "Stopping any conflicting containers"
echo "***************************"
docker-compose -f ${COMPOSE_MOUNTED} down

echo "***************************"
echo "Starting up ephemeral containers"
echo "***************************"
docker-compose -f ${COMPOSE_EPHEMERAL} up -d
...
docker cp sonarqube:/opt/sonarqube/logs ./volumes/sonarqube/logs
...
echo "***************************"
docker-compose -f ${COMPOSE_EPHEMERAL} down

echo "***************************"
echo "Starting up persistent containers"
echo "***************************"
docker-compose -f ${COMPOSE_MOUNTED} up --build -d